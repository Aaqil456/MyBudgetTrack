...
public class Bil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Bil.this,BilListActivity.class));
                finish();
            }
        });
        ...
        db.collection("bil1").document(id)
                .update("Wang perbelanjaan",wang
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        pd.dismiss();
                        Toast.makeText(Bil.this,"Telah dikemaskini",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(Bil.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
