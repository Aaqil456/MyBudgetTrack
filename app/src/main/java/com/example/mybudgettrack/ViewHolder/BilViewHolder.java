...
public class BilViewHolder extends RecyclerView.ViewHolder{
    ...
    public BilViewHolder(@NonNull View itemView) {
        super(itemView);
        mView = itemView;
        //item click
    ...
    private BilViewHolder.ClickListener mClickListener;
    ...
    public void setOnClickListener(BilViewHolder.ClickListener clickListener){
